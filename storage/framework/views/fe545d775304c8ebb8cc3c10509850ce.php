                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav  mx-auto ">
                            <li class="nav-item active">
                                <a class="nav-link" href="<?php echo e(route('home')); ?>">Dashboard <span
                                        class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('menus.index')); ?>">Menu</a>
                            </li>
                            <li class="nav-item">
...
</html><?php /**PATH C:\xampp\htdocs\RestaurantOrderingSystem-main\resources\views/welcome.blade.php ENDPATH**/ ?>
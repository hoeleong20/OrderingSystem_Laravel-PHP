...
<body class="sub_page">
    ...
    <div class="hero_area">
        <div class="bg-box">
            <img src="<?php echo e(asset('images/hero-bg.jpg')); ?>" alt="">
        </div>
                ...
                <nav class="navbar navbar-expand-lg custom_nav-container ">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav  mx-auto ">
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('admin.adminDashboard')); ?>">Dashboard </a>
                            </li>
                            <li class="nav-item active">
                                <a class="nav-link" href="<?php echo e(route('menus.adminMenu')); ?>">Menu <span
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('book')); ?>">Book Table</a>
                            </li>
                        </ul>
                        <!-- User Dropdown -->
                        <div class="user_option">
                            ...
                            <?php else: ?>
                                ...
                                <a href="<?php echo e(route('login')); ?>" class="user_link">
                                    <i class="fa fa-user" aria-hidden="true"></i> <?php echo e(__('Login')); ?>
    ...
    <section class="layout_padding">
        <div class="heading_container heading_center">
            ...
            <hr />
            <form action="<?php echo e(route('menus.sendSoldOutMenus')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <button type="submit" class="btn btn-primary">Send Sold Out Menus</button>
            </form>
                <a href="<?php echo e(route('menus.activatePage')); ?>" class="btn btn-success">Activate Menus</a>
        </div>
        <div class="container">
            <div class="row">
                    ...
                    <table border="1" cellpadding="10">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($menu->menu_code); ?></td>
                                    <td><?php echo e($menu->name); ?></td>
                                    <td><?php echo e($menu->desc); ?></td>
                                    <td><?php echo e($menu->price); ?></td>
                                    <td><?php echo e($menu->status); ?></td>
                                    <td><?php echo e(is_array($menu->remarkable) ? implode(', ', $menu->remarkable) : ''); ?></td>
                                    <td>
                                        <button type="button"
                                            onclick="editMenu('<?php echo e($menu->menu_code); ?>', '<?php echo e($menu->name); ?>', '<?php echo e($menu->desc); ?>', '<?php echo e($menu->price); ?>', '<?php echo e(json_encode($menu->remarkable)); ?>')">
                                            Edit
                                        </button>
                                    </td>
                                    <td>
                                        <form method="post" action="<?php echo e(route('menus.destroy', $menu->menu_code)); ?>"
    ...
    <script>
        ...
        function editMenu(menuCode, name, desc, price, remarks) {
            ...
            let remarkList = <?php echo json_encode($remarks, 15, 512) ?>;
            let remarkTable = '';
...
<?php /**PATH C:\xampp\htdocs\RestaurantOrderingSystem-main\resources\views/menus/adminMenu.blade.php ENDPATH**/ ?>
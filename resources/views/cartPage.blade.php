    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-10">
        ...
        <div class="card fixed-bottom flex-row col-7 mb-3" style="margin:auto">
          <!-- div class="card-body d-flex flex-row col-2"></div> -->
            <div class="card-body d-flex flex-row ">
              <button  type="button" class="btn btn-outline-warning btn-lg col-6" id="goToMenuBtn">Add More Items</button>
              <button  type="button" class="btn btn-warning btn-block btn-lg ms-3 col-6" id="placeOrderBtn">Place Order</button>
            </div>
        </div>
...
<script>
  document.getElementById('placeOrderBtn').addEventListener('click', function() {
    window.location.href = "{{ route('orderSummaryPage') }}";
  });
